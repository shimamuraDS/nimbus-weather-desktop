...
| **Package Artifact** | `NimbusWeather-1.0.4-win64-Standard.msi` | `NimbusWeather-1.0.4-win64-AI.msi` |
| **Portable Archive** | `NimbusWeather-1.0.4-win64-Standard.zip` | `NimbusWeather-1.0.4-win64-AI.zip` |
